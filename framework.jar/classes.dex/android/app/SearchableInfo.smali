...
.method private static createActivityContext(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Context;
    ...
    :try_end_b
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_3 .. :try_end_b} :catch_d
    .catch Ljava/lang/SecurityException; {:try_start_3 .. :try_end_b} :catch_2c
...
.method private static getActivityMetaData(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/ComponentName;)Landroid/app/SearchableInfo;
    ...
    :try_end_13
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_10 .. :try_end_13} :catch_b9
    .catch Ljava/io/IOException; {:try_start_10 .. :try_end_13} :catch_da
    ...
    :try_end_2b
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_1b .. :try_end_2b} :catch_103
    .catch Ljava/io/IOException; {:try_start_1b .. :try_end_2b} :catch_ff
    ...
    :try_end_33
    .catch Ljava/lang/IllegalArgumentException; {:try_start_2e .. :try_end_33} :catch_39
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_2e .. :try_end_33} :catch_103
    .catch Ljava/io/IOException; {:try_start_2e .. :try_end_33} :catch_ff
    ...
    invoke-interface {p1}, Lorg/xmlpull/v1/XmlPullParser;->next()I
    :try_end_36
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_33 .. :try_end_36} :catch_b9
    .catch Ljava/io/IOException; {:try_start_33 .. :try_end_36} :catch_da
    ...
    invoke-static {p1}, Landroid/util/Xml;->asAttributeSet(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    :try_end_7c
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_3b .. :try_end_7c} :catch_103
    .catch Ljava/io/IOException; {:try_start_3b .. :try_end_7c} :catch_ff
    ...
    :try_end_87
    .catch Ljava/lang/IllegalArgumentException; {:try_start_7f .. :try_end_87} :catch_89
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_7f .. :try_end_87} :catch_103
    .catch Ljava/io/IOException; {:try_start_7f .. :try_end_87} :catch_ff
    ...
    invoke-static {v7, v8}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_b5
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_8b .. :try_end_b5} :catch_103
    .catch Ljava/io/IOException; {:try_start_8b .. :try_end_b5} :catch_ff
