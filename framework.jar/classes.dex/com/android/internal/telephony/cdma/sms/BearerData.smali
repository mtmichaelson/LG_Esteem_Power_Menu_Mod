...
.method private static decodeInvalid([BII)Ljava/lang/String;
    .registers 11
    .parameter "data"
    .parameter "offset"
    .parameter "numFields"
    ...
    throw v5
    :try_end_3e
    .catch Lcom/android/internal/util/BitwiseInputStream$AccessException; {:try_start_2 .. :try_end_3e} :catch_3e
    ...
    invoke-direct {v5, v1, v6, p2}, Ljava/lang/String;-><init>([BII)V
    :try_end_73
    .catch Lcom/android/internal/util/BitwiseInputStream$AccessException; {:try_start_59 .. :try_end_73} :catch_3e
...
.method private static decodeSmsAddress(Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;)V
    ...
    .line 1324
    :try_start_7
    const-string/jumbo v2, "persist.service.sms_nbpcd"
    ...
    const-string v4, "CB and Etc Address DIGIT_MODE_8BIT_CHAR and Address : "
    ...
    .line 1329
    .local v1, tempAddr:Ljava/lang/String;
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/SmsAddress;->address:Ljava/lang/String;

    .line 1330
    const-string v2, "YJJO_BearerData"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "8bit international without plus, So attached plus = "
    ...
    .line 1350
    .end local v1       #tempAddr:Ljava/lang/String;,
    :goto_6b
    return-void
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/SmsAddress;->address:Ljava/lang/String;
    :try_end_7b
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_7 .. :try_end_7b} :catch_7c
    ...
    const-string v3, "invalid SMS address ASCII code"
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/SmsAddress;->address:Ljava/lang/String;
    :try_end_95
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_86 .. :try_end_95} :catch_7c
    ...
    invoke-static {v2, v3}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeDtmfSmsAddress([BI)Ljava/lang/String;
...
.method private static decodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;Z)V
    ...
    const-string v7, "msgEncoding INVALID"
    ...
    invoke-static {v6, v3, v7}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeInvalid([BII)Ljava/lang/String;
...
.method private static encodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;)V
    ...
    :try_end_c0
    .catch Lcom/android/internal/telephony/cdma/sms/BearerData$CodingException; {:try_start_b4 .. :try_end_c0} :catch_cc
