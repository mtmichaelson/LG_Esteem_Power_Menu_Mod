.class public Lcom/lge/sui/widget/list/internal/SUITwoLineListItemView;
.super Lcom/lge/sui/widget/list/SUIListItemView;
.source "SUITwoLineListItemView.java"
...
.method protected getItemView(Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .prologue
    .line 28
    invoke-virtual {p0, p1}, Lcom/lge/sui/widget/list/internal/SUITwoLineListItemView;->getTwoLineTextView(Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, Lcom/lge/sui/widget/list/internal/SUITwoLineListItemView;->getPixel(I)I

    move-result v1

    iget v2, p0, Lcom/lge/sui/widget/list/SUIListItemView;->mTopPadding:I

    invoke-virtual {p0, v2}, Lcom/lge/sui/widget/list/internal/SUITwoLineListItemView;->getPixel(I)I

    move-result v2

    iget v3, p0, Lcom/lge/sui/widget/list/SUIListItemView;->mRightPadding:I

    invoke-virtual {p0, v3}, Lcom/lge/sui/widget/list/internal/SUITwoLineListItemView;->getPixel(I)I

    move-result v3

    iget v4, p0, Lcom/lge/sui/widget/list/SUIListItemView;->mBottomPadding:I

    invoke-virtual {p0, v4}, Lcom/lge/sui/widget/list/internal/SUITwoLineListItemView;->getPixel(I)I
